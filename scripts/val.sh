...
deepspeed --num_gpus $NUM_GPUS validate_bert.py --deepspeed_config configs/ds_config.json --config configs/student.yaml --use_enhanced_loss --loss_config_path configs/enhanced_loss_config.yaml > 我的论文模型的验证集-1208-不缺少position_ids.log 2>&1