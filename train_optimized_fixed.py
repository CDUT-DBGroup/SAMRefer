...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for batch_idx, (samples, targets) in enumerate(pbar):
            ...
            #         img_pil = transforms.ToPILImage()(img[i].float())
            #         mask_pil = transforms.ToPILImage()(target[i].float())
            #         img_pil, mask_pil = data_augmentation(img_pil, mask_pil, epoch)
            #         img[i] = transforms.ToTensor()(img_pil)
            #         target[i] = transforms.ToTensor()(mask_pil)
